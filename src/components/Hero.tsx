...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 sm:px-8 md:px-12 py-24 md:py-32 md:pl-[5%]">
                <div className="text-center md:text-left max-w-5xl space-y-16 md:space-y-24 flex flex-col items-center md:items-start">
                    <motion.div
                    ...
                    >
                        <h1 className="font-extrabold leading-[0.9] tracking-tighter mb-10 md:mb-12 min-h-[1.2em] text-6xl md:text-[clamp(4.5rem,10vw,9rem)]">
                            {typedText}
                            <motion.span
                                animate={{ opacity: [0, 1, 0] }}
                                transition={{ duration: 0.8, repeat: Infinity }}
                                className="inline-block w-2 h-[0.8em] bg-accent ml-2 align-middle"
                            />
                        </h1>
                        <motion.span
                            ...
                            className="text-accent font-black tracking-[0.4em] uppercase text-xs sm:text-base px-8 py-3 glass rounded-full border-accent/20"
                        >
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-3xl text-foreground-muted max-w-3xl font-medium leading-relaxed"
                    >
                    ...
                    >
                        <Button size="lg" className="rounded-2xl px-16 h-20 text-xl group shadow-2xl shadow-accent/30">
                            <a href="#portfolio" className="flex items-center gap-2">
                                Explore Portfolio
                            </a>
                        </Button>
                        <Button size="lg" variant="secondary" className="rounded-2xl px-16 h-20 text-xl glass border-white/5 hover:bg-white/5">
